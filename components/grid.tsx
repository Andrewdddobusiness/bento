    ...
    return layouts.lg.map((l: any, i: number) => (
      <div key={l.i} className={l.static ? "static" : ""}>
        {l.static ? (
          ...
          >
            <div key="22" className="rounded-3xl bg-light_grey_p  dark:bg-[#1a1a1a] h-full ">
              {l.i === "1" ? <Profile /> : null}
              {l.i === "2" ? <LinkedInIcon /> : null}
              {l.i === "3" ? <Subs currentSubscribers={1000} goalSubscribers={10000} /> : null}
              {l.i === "4" ? <Buildtopia /> : null}
              {l.i === "5" ? <DarkModeSwitch /> : null}

              {l.i === "6" ? <YouTubeVideo videoId="eUCwQKCDGEs" /> : null}
              {l.i === "7" ? <ComingSoon /> : null}
